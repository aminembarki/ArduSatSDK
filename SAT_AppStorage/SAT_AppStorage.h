/** @brief  Library to write Arduino application data from Arduino to the supervisor.
    ...
    This is the library to use for writing experiment data that you would like downloaded 
	through the ground station network and available to download from the control center.
